...
public class JEIPlugin implements IModPlugin {
	...
	public void registerCategories(IRecipeCategoryRegistration registry) {
		...
		registry.addRecipeCategories(new CategoryFluidCentrifuge(registry.getJeiHelpers().getGuiHelper()));
	...
	public void register(@Nonnull IModRegistry registry) {
		...
		registry.handleRecipes(RecipeFluidCentrifuge.class, recipe -> new WrapperFluidCentrifuge(registry.getJeiHelpers(), recipe), CategoryFluidCentrifuge.uid);
		...
		registry.addRecipes(RecipeMakerFluidCentrifuge.getRecipes(registry.getJeiHelpers()), CategoryFluidCentrifuge.uid);
		...
		registry.addRecipeCatalyst(new ItemStack(ModBlocks.fluid_centrifuge), CategoryFluidCentrifuge.uid);
