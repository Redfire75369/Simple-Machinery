...
public class SimpleMachineryJEI implements IModPlugin {
	...
	public void registerCategories(IRecipeCategoryRegistration registry) {
		...
		registry.addRecipeCategories(new FluidCentrifugeCategory(registry.getJeiHelpers().getGuiHelper()));
	...
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
		...
		registration.addRecipeCatalyst(new ItemStack(Blocks.FLUID_CENTRIFUGE_BLOCK.get()), FluidCentrifugeCategory.UID);
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration.addRecipes(FluidCentrifugeRecipe.getAllRecipes(world), FluidCentrifugeCategory.UID);
